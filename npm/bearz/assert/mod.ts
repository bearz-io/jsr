...
function arrayIncludes(actual: any[], expected: any[], msg?: string) {
    return include(actual, expected, msg);
}

function stringIncludes(actual: string, expected: string, msg?: string) {
    return include(actual, expected, msg);
}

function almostEqual(actual: number, expected: number, delta: number, msg?: string) {
    return closeTo(actual, expected, delta, msg);
}

// biome-ignore lint/suspicious/noExplicitAny: false positive
function objectMatch(actual: any, expected: any, msg?: string) {
    return deepOwnInclude(actual, expected, msg);
}

function less(actual: number, expected: number, msg?: string) {
    return isBelow(actual, expected, msg);
}

function lessOrEqual(actual: number, expected: number, msg?: string) {
    return isAtMost(actual, expected, msg);
}

function greater(actual: number, expected: number, msg?: string) {
    return isAbove(actual, expected, msg);
}

function greaterOrEqual(actual: number, expected: number, msg?: string) {
 ...
 */
function isError<E extends Error = Error>(
    error: unknown,
 ...
 */
function rejects(fn: () => PromiseLike<unknown>, msg?: string): Promise<unknown>;
/**
 * Executes a function which returns a promise, expecting it to reject.
 ...
 * @returns The promise which resolves to the thrown error.
 */
function rejects<E extends Error = Error>(
...
async function rejects<E extends Error = Error>(
    fn: () => PromiseLike<unknown>,
