...
import { NotImplementedError } from "./not_implemented_error.ts";

// DO NOT REMOVE
// This line is used by automation to convert to vitest
const test = Deno.test;
const errorName = "NotImplementedError";

test("errors:: NotImplementedError", () => {
    const x = new NotImplementedError();
    ok(x instanceof Error);
    equal(x.message, "Not implemented.");
    ...
    const y = new NotImplementedError({
        message: "test",
        target: "target",
        link: "link",
        cause: x,
